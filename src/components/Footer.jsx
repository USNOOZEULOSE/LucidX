    ...
    <Footer style={gradientStyle}>
      <div className="w-full">
        <div className="grid w-full grid-cols-2 gap-8 px-6 py-8 md:grid-cols-5">
          <div>
            <Footer.Title className="text-white"  title="Get Started" />
          ...
          <div>
            <Footer.Title className="text-white" title="Services" />
            <Footer.LinkGroup className="text-white"col>
          ...
          <div>
            <Footer.Title className="text-white" title="Resources" />
            <Footer.LinkGroup className="text-white"col>
          ...
          <div>
            <Footer.Title className="text-white" title="Partnerships" />
            <Footer.LinkGroup className="text-white"col>
